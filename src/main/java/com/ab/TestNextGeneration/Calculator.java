...
public class Calculator {
	...
	public static double addition(int a , double b) {  return (a+b); }
	...
	public static double substraction(int a , double b) {  return (a-b); }
	
	public static double substraction(double a , int b) {  return (a-b); }
	
	public static double substraction(double a , double b) {  return (a-b); }
	
	public static int multiplication(int a , int b) {  return (a*b); }
	
	public static double multiplication(int a , double b) {  return (a*b); }
	...
	public static double division (int a , double b) { return (a/b); }
	
	public static double division (double a , int b ) { return (a/b); }
